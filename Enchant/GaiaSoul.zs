...
val GS = <minecraft:enchanted_book>.withTag({display: {Lore: ["§d§lGaia Soul", "§7Cost:§a 300xp", "§7Used:", "§7-§6 Failnaught", "§7- §fSoulscribe", "", "§d§lMYSTERY BOOK"], Name: "§eEnchanted Book"}});
