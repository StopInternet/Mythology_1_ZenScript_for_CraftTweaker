...
mods.extendedcrafting.TableCrafting.addShaped(2, <minecraft:chest>.withTag({BlockEntityTag: {CustomName: "§5BluePrint Chest", ForgeCaps: {"nuclearcraft:capability_default_radiation_resistance": {radiationResistance: 0.0}}, Items: [{Slot: 2 as byte, id: "modularmachinery:itemblueprint", Count: 1 as byte, tag: {dynamicmachine: "modularmachinery:zero_type_beekeeping_box"}, Damage: 0 as short}, {Slot: 3 as byte, id: "modularmachinery:itemblueprint", Count: 1 as byte, tag: {dynamicmachine: "modularmachinery:cr_assembler"}, Damage: 0 as short}, {Slot: 4 as byte, id: "modularmachinery:itemblueprint", Count: 1 as byte, tag: {dynamicmachine: "modularmachinery:alloy_furnace"}, Damage: 0 as short}, {Slot: 5 as byte, id: "modularmachinery:itemblueprint", Count: 1 as byte, tag: {dynamicmachine: "modularmachinery:fei_finally_crafting_machine"}, Damage: 0 as short}, {Slot: 6 as byte, id: "modularmachinery:itemblueprint", Count: 1 as byte, tag: {dynamicmachine: "modularmachinery:type_zero_assembler"}, Damage: 0 as short}, {Slot: 13 as byte, id: "modularmachinery:itemblueprint", Count: 1 as byte, tag: {dynamicmachine: "modularmachinery:life_essence_generator"}, Damage: 0 as short}, {Slot: 21 as byte, id: "modularmachinery:itemblueprint", Count: 1 as byte, tag: {dynamicmachine: "modularmachinery:dragon_fusion_reactor"}, Damage: 0 as short}, {Slot: 23 as byte, id: "modularmachinery:itemblueprint", Count: 1 as byte, tag: {dynamicmachine: "modularmachinery:infinity_reactor"}, Damage: 0 as short}], id: "minecraft:chest", Lock: ""}, display: {Lore: ["§7It contains the BluePrint", "§7required by Modular Machinery.", "", "§6§lLEGENDARY CHEST"], Name: "§6Blueprint Chest"}}), [
...
//Hyper Compressed EnderPearl
mods.extendedcrafting.CompressionCrafting.addRecipe(Tesselated_Ender_Pearl, <actuallyadditions:block_misc:6>, 128000, <extendedcrafting:material:11>, 5000000);
...
mods.extendedcrafting.TableCrafting.addShaped(2, Thunder_Shard, [
	[<extendedcrafting:storage:7>, <ore:ingotUltimate>, <ore:ingotUltimate>, <ore:ingotUltimate>, <extendedcrafting:storage:7>], 
	[<ore:ingotUltimate>, <sccraftingrunes:itemraremat>, Pured_Prismarine_Crystal, <sccraftingrunes:itemraremat>, <ore:ingotUltimate>], 
	[<ore:ingotUltimate>, Water_Shard, <extendedcrafting:singularity:4>, Water_Shard, <ore:ingotUltimate>], 
	[<ore:ingotUltimate>, <sccraftingrunes:itemraremat>, Pured_Prismarine_Crystal, <sccraftingrunes:itemraremat>, <ore:ingotUltimate>], 
	[<extendedcrafting:storage:7>, <ore:ingotUltimate>, <ore:ingotUltimate>, <ore:ingotUltimate>, <extendedcrafting:storage:7>]
]);

mods.extendedcrafting.CompressionCrafting.addRecipe(void_orb, <contenttweaker:void_essence>, 1000, <extendedcrafting:material:13>, 2000000);
mods.extendedcrafting.CompressionCrafting.addRecipe(<contenttweaker:giga_matter>, <projectex:clay_matter>, 256, <extendedcrafting:material:13>, 6000000);
mods.extendedcrafting.CompressionCrafting.addRecipe(Superior_Cristal, Metor_Shard, 256, <extendedcrafting:material:13>, 3000000);
mods.extendedcrafting.CompressionCrafting.addRecipe(<contenttweaker:spiritsoul4>, <randomthings:ingredient:2>, 512, <extendedcrafting:material:13>, 3000000);

mods.extendedcrafting.TableCrafting.addShaped(2, <avaritiaddons:avaritiaddons_chest>, [
	[<ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>], 
	[<ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>], 
	[<ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>], 
	[<ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>], 
	[<ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>, <ironchest:iron_chest:6>]
